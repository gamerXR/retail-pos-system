              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {salesData.map((sale, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{sale.totalSales}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">฿{sale.totalRevenue.toLocaleString()}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">฿{sale.cashSales.toLocaleString()}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">฿{sale.qrSales.toLocaleString()}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">฿{sale.otherSales.toLocaleString()}</td>
                  </tr>
                ))}
              </tbody>
            </table>
