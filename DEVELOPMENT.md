...
```bash
git remote add encore encore://retail-pos-system-mmn2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/retail-pos-system-mmn2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/retail-pos-system-mmn2/settings/integrations/github)
